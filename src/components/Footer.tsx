        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-muted-foreground">
                ...
                <span>Chambéry, Savoie</span>
              </div>
              <div className="flex items-center gap-2 text-muted-foreground">
                <Phone className="w-5 h-5 text-primary" />
                <span>+33 6 70 45 32 30       </span>
              </div>
              <div className="flex items-center gap-2 text-muted-foreground">
                <Mail className="w-5 h-5 text-primary" />
                <span>contact@elabsite.fr</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <nav className="space-y-2">
              <Link to="/creation-site-internet-chambery" className="block text-muted-foreground hover:text-primary transition-colors">
                Création site Chambéry
              </Link>
              <Link to="/creation-site-internet-grenoble" className="block text-muted-foreground hover:text-primary transition-colors">
                Création site Grenoble
              </Link>
              <Link to="/creation-site-internet-annecy" className="block text-muted-foreground hover:text-primary transition-colors">
