...
const services = [
  {
    ...
    description:
      "Un site web sur mesure qui reflète votre image de marque et met en valeur vos services auprès de votre clientèle chambérienne.",
  },
  {
    icon: Smartphone,
    title: "Design responsive & mobile-first",
    description:
      "Votre site s'adapte parfaitement à tous les écrans : smartphone, tablette et ordinateur pour toucher tous vos clients à Chambéry.",
  },
  {
    icon: Search,
    title: "Référencement local Chambéry",
    description:
      "Optimisation SEO locale pour apparaître en haut des résultats Google quand vos clients cherchent vos services en Savoie.",
  },
  {
    icon: Shield,
...
const faqs = [
  {
    ...
    answer:
      "Mes tarifs commencent à 190€ TTC pour une page unique et à partir de 390€ TTC pour un site vitrine complet jusqu'à 5 pages. Je propose des prix compétitifs grâce à ma structure légère et mes outils modernes.",
  },
  {
    question: "Combien de temps faut-il pour créer un site web à Chambéry ?",
    answer:
      "Selon la formule choisie, votre site peut-être livré en 7 jours (page unique), 15 jours (site vitrine) ou 21 jours (site vitrine + mini-boutique).",
  },
  {
    question: "Mon site sera-t-il bien référencé sur Google à Chambéry ?",
    answer:
      "Oui, tous mes sites incluent une optimisation SEO locale ciblant Chambéry et la Savoie : balises meta, données structurées, contenu optimisé, inscription Google Business Profile et stratégie de mots-clés locaux.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "J'accompagne tous les professionnels : artisans, commerçants, professions libérales, PME, associations et auto-entrepreneurs de Chambéry et ses environs (Aix-les-Bains, Albertville, La Motte-Servolex).",
  },
];
...
const CreationSiteChambery = () => {
  ...
  const jsonLd = {
    ...
    description:
      "Agence web spécialisée dans la création de sites internet professionnels à Chambéry, Savoie. Sites vitrine, référencement SEO local et maintenance.",
        ...
        <section className="py-20 bg-secondary/30" aria-labelledby="pourquoi-chambery">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2
                  id="pourquoi-chambery"
                  className="text-3xl md:text-4xl font-bold mb-6 text-foreground"
                >
                  Pourquoi choisir mon expertise web à Chambéry ?
                </h2>
                <p className="text-muted-foreground text-lg mb-8">
                  En tant qu'<strong>agence web local à Chambéry</strong>, je comprends les besoins spécifiques des
                  entreprises savoyardes. Ma proximité géographique me permet d'offrir un accompagnement personnalisé
                  et réactif.
                </p>
              ...
              <div className="bg-card rounded-2xl p-8 shadow-lg">
                ...
                <p className="text-sm text-muted-foreground mt-4 italic">
                  …et bien d'autres villes en Savoie et alentours.
                </p>
              </div>
            </div>
          </div>
